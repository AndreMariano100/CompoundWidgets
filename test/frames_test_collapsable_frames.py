...
frame_1 = cw.CollapsableFrame(root, title='No style disabled', disabled=True)
frame_1.grid(row=1, column=0, sticky='nsew', padx=10, pady=10)

frame_2 = cw.CollapsableFrame(root, title='Danger disabled', style='danger', disabled=True)
frame_2.grid(row=3, column=0, sticky='nsew', padx=10, pady=(0, 10))

frame_3 = cw.CollapsableFrame(root, title='Info disabled', open_start=False, style='info', disabled=True)
frame_3.grid(row=5, column=0, sticky='nsew', padx=10, pady=(0, 10))

frame_4 = cw.CollapsableFrame(root, title='Success disabled', open_start=False, style='success', disabled=True)
frame_4.grid(row=7, column=0, sticky='nsew', padx=10, pady=(0, 10))
